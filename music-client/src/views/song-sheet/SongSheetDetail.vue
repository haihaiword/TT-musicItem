<template>
  <el-container>
    <el-aside class="album-slide">
      <el-image style="height: 500px;" class="album-img" fit="contain" :src="attachImageUrl(songDetails.pic)" />
    </el-aside>
    <el-main class="album-main">
      <h3 style="padding-bottom: 100px; text-align: center;" class="album-info">{{ songDetails.title }}</h3>
      <h1>简介</h1>
